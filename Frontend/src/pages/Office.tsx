  ...
  return (
    <>
      ...
      <div className="w-full h-14 p-8 items-center flex justify-center">
        <h1 className="text-black text-yellow-950 font-bold font-sans md:font-serif text-[30px]">Offices</h1>
      </div>
      <div className="container mx-auto mt-6 mb-6 ">
        ...
        >
          <thead className="h-[20px] min-h-[1em] w-px self-stretch opacity-100 dark:opacity-900">
            <tr>
              <th>Office Code</th>
              <th>City</th>
              <th>Phone</th>
          ...
          <tbody className="h-[250px] min-h-[1em] w-px self-stretch opacity-100 dark:opacity-900">
